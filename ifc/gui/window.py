...
class IFCWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        # Shows a dialog if a new release is present on github
    ...
    def check_for_updates():
        ...
        if latest_major > utils.MAJOR or (
                latest_major == utils.MAJOR and (
                    latest_minor > utils.MINOR or (
                        latest_minor == utils.MINOR and latest_patch > utils.PATCH
                    )
                )
        ):
